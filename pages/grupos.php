                    ...
                    <div class="grid grid-3">
                        <div class="form-group" style="margin-bottom: 0;">
                            <input type="text" id="searchInput" class="form-input"
                                   placeholder="Buscar por nombre del grupo o nombre de la materia.">
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="modal-body">
                    ...
                    <div class="grid grid-2">
                        <div class="form-group">
                            ...
                            <select id="carrera_id" name="carrera_id" class="form-input">
                                <option value="">Todas las carreras</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <select id="semestre_actual" class="form-input">
                                <option value="">Todos los semestres</option>
                            </select>
                        </div>
                    ...
                    <div class="grid grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-input" placeholder="Ej: POO-A"
                                   required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Cupo Máximo</label>
                            <input type="number" id="cupo_maximo" name="cupo_maximo" class="form-input" min="1" max="30"
                                   placeholder="Máximo: 30 alumnos" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="periodo_academico" name="periodo_academico" class="form-input"
                               placeholder="Ej: Agosto-Diciembre 2025" required>
                    </div>

                    <div class="form-group">
                        <label for="num_alumnos" class="form-label">Numero de Alumnos</label>
                        <input type="number" id="alumnos_inscriptos" name="alumnos_inscriptos" class="form-input" placeholder="Ej: 23"
                               required>
                    </div>
